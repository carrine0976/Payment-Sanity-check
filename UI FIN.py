...
def fee_record_3PL_311(driver:webdriver.Chrome):
    ...
    span=[]
    filter_list=[]
    expect_list1=['Fee Record ID','Fee Type','Store ID','Merchant ID','SKU ID','Is Fragile','Is Extra Fragile','Is Sensitive','Unit Price','QTY','Total Price']
    ...
    span_tab=['Invoice No.','Store ID','Merchant ID','SKU ID','Sub-Order No.','Waybill No.','Booking No.','Fee Record ID']
    ...
    try:
        ...
        merchant=driver.find_element(By.XPATH, "(//span[text()='Merchant ID'])[2]").text
        span.append(merchant)
        print(f"Tab:{merchant}")
        time.sleep(0.5)
        ...
        print("Data are all match!!!! case PASS")
        print("\n")
